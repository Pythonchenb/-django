...
class CourceOrg(models.Model):
    ...
    category = models.CharField(default=0,verbose_name='机构类别',max_length=20,choices=(('pxjg','培训机构'),('gr','个人'),('gx','高校')))
    fav_nums = models.IntegerField(default=0,verbose_name='收藏数')
    image = models.ImageField(upload_to='org/%Y/%m',verbose_name='封面图')
    address = models.CharField(max_length=50,verbose_name='机构地址')
    cources_order = models.CharField(default=0,verbose_name='课程数',max_length=50)
    students_order = models.CharField(default=0,verbose_name='学习人数',max_length=50)
